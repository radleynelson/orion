...
export function AdoptWorkspace(arg1) {
  return window['go']['main']['App']['AdoptWorkspace'](arg1);
}
...
export function CleanupAdoptedWorkspace(arg1) {
  return window['go']['main']['App']['CleanupAdoptedWorkspace'](arg1);
}
